...
def encounter(id, gang, waves, **kw):
    p = dict(id=id, gang=gang, waves=waves, max_active=4,
             ...
             respawn_on_reenter=True, boss_id="", reward_flag="", music=None,
             intro_dialogue="", clear_dialogue="")
    p.update(kw)
    # A fight gets the battle track unless it is a boss, which has its own. Encounters used
    # to name a track each, and almost every one named the track its own area was already
    # playing -- so the music never changed and the fights sounded like the street.
    if p["music"] is None:
        p["music"] = "boss" if p["boss_id"] else "battle"
    return p
...
ENCOUNTERS = [
    ...
    encounter("line_four_1", "crew", [wave("crew_grunt", 2, "any"), wave("crew_weapon", 2, "any", 2.2),
              ...
              max_active=4, once_flag="enc_line_four_1"),
    ...
    encounter("line_four_2", "crew", [wave("crew_weapon", 2, "any"), wave("crew_grunt", 3, "any", 1.6),
              ...
              max_active=4, intro_dialogue="gangs_arrive",
    ...
    encounter("market_shakedown", "sweaters", [wave("sweater_grunt", 3), wave("sweater_grappler", 1, "right", 0.6)],
              max_active=4, reward_flag="market_cleared"),
    ...
    encounter("alley_boss_fight", "grease", [wave("grease_weapon", 2), wave("grease_grunt", 2, "any", 0.4),
              ...
              max_active=4, reward_flag="alley_cleared",
    ...
    encounter("yard_wave_2", "rust_rats", [wave("rust_heavy", 1, "right"), wave("rust_ranged", 2, "any", 0.5),
              ...
              max_active=4, reward_flag="yard_cleared"),
    ...
    encounter("hideout_elites", "cleaners", [wave("cleaner_elite", 2), wave("cleaner_grappler", 2, "any", 0.5),
              ...
              max_active=4, reward_flag="hideout_cleared"),
    ...
    encounter("metro_platform_2", "commuters", [wave("commuter_grunt", 2), wave("commuter_ranged", 2, "any", 0.4),
              ...
              max_active=4, reward_flag="metro_cleared"),
